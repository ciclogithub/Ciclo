    ...
    public class RelatoriosDB
    {
        ...
        public List<Relatorios> ListarAluno(FormCollection collection)
        {
            try
            {
                ...
                qry = "SELECT T.TXTEMA, C.TXIDENTIFICADOR, C.TXCURSO, CD.DTCURSO, ";
                ...
                qry += "LEFT JOIN CORES CO1 ON CO1.IDCOR = C.IDCOR ";
                qry += "LEFT JOIN TEMAS T ON T.IDTEMA = C.IDTEMA ";
                ...
                qry += "ORDER BY T.TXTEMA";
                Query query = session.CreateQuery(qry);
                IDataReader reader = query.ExecuteQuery();

                while (reader.Read())
                {
                    list_relat.Add(new Relatorios(1, Convert.ToString(reader["TXCURSO"]), Convert.ToString(reader["DTCURSO"]), Convert.ToString(reader["TXALUNO"]), Convert.ToString(reader["TXEMPRESA"]), Convert.ToString(reader["CORCURSO"]), Convert.ToString(reader["CORALUNO"]), Convert.ToString(reader["TXTEMA"]), Convert.ToString(reader["TXINSTRUTOR"]), Convert.ToString(reader["TXESPECIALIDADE"]), Convert.ToString(reader["CIDADECURSO"]), Convert.ToString(reader["ESTADOCURSO"]), Convert.ToString(reader["CIDADEALUNO"]), Convert.ToString(reader["ESTADOALUNO"]), Convert.ToString(reader["TXLOCAL"]), Convert.ToString(reader["TXCATEGORIA"]), Convert.ToString(reader["TXIDENTIFICADOR"]), 0));
                }
                reader.Close();
                session.Close();
        ...
        public List<Relatorios> ListarCategoria(FormCollection collection)
        {
            try
            {
                ...
                if ((collection["dtini"] != "") && (collection["dtfim"] != "")) { qry += "AND CD.DTCURSO BETWEEN '" + collection["dtini"] + "' AND '" + collection["dtfim"] + "' "; }
                if (collection["dtmes"] != "") { qry += "AND MONTH(CD.DTCURSO) = " + collection["dtmes"] + " "; }
                qry += "ORDER BY CT.TXCATEGORIA";
                Query query = session.CreateQuery(qry);
                IDataReader reader = query.ExecuteQuery();

                while (reader.Read())
                {
                    list_relat.Add(new Relatorios(1, Convert.ToString(reader["TXCURSO"]), Convert.ToString(reader["DTCURSO"]), "", "", Convert.ToString(reader["CORCURSO"]), "", Convert.ToString(reader["TXTEMA"]), "", "", "", "", "", "", Convert.ToString(reader["TXLOCAL"]), Convert.ToString(reader["TXCATEGORIA"]), Convert.ToString(reader["TXIDENTIFICADOR"]), Convert.ToInt32(reader["ALUNOS"])));
                }
                reader.Close();
                session.Close();
        ...
        public List<Relatorios> ListarClassificacaoAluno(FormCollection collection)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    list_relat.Add(new Relatorios(3, Convert.ToString(reader["TXCURSO"]), Convert.ToString(reader["DTCURSO"]), Convert.ToString(reader["TXALUNO"]), Convert.ToString(reader["TXEMPRESA"]), Convert.ToString(reader["CORCURSO"]), Convert.ToString(reader["CORALUNO"]), Convert.ToString(reader["TXTEMA"]), Convert.ToString(reader["TXINSTRUTOR"]), Convert.ToString(reader["TXESPECIALIDADE"]), Convert.ToString(reader["CIDADECURSO"]), Convert.ToString(reader["ESTADOCURSO"]), Convert.ToString(reader["CIDADEALUNO"]), Convert.ToString(reader["ESTADOALUNO"]), Convert.ToString(reader["TXLOCAL"]), Convert.ToString(reader["TXCATEGORIA"]), Convert.ToString(reader["TXIDENTIFICADOR"]), 0));
                }
                reader.Close();
                session.Close();
        ...
        public List<Relatorios> ListarCurso(FormCollection collection)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    list_relat.Add(new Relatorios(5, Convert.ToString(reader["TXCURSO"]), Convert.ToString(reader["DTCURSO"]), Convert.ToString(reader["TXALUNO"]), Convert.ToString(reader["TXEMPRESA"]), Convert.ToString(reader["CORCURSO"]), Convert.ToString(reader["CORALUNO"]), Convert.ToString(reader["TXTEMA"]), Convert.ToString(reader["TXINSTRUTOR"]), Convert.ToString(reader["TXESPECIALIDADE"]), Convert.ToString(reader["CIDADECURSO"]), Convert.ToString(reader["ESTADOCURSO"]), Convert.ToString(reader["CIDADEALUNO"]), Convert.ToString(reader["ESTADOALUNO"]), Convert.ToString(reader["TXLOCAL"]), Convert.ToString(reader["TXCATEGORIA"]), Convert.ToString(reader["TXIDENTIFICADOR"]), 0));
                }
                reader.Close();
                session.Close();
        ...
        public List<Relatorios> ListarEspecialidade(FormCollection collection)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    list_relat.Add(new Relatorios(6, Convert.ToString(reader["TXCURSO"]), Convert.ToString(reader["DTCURSO"]), Convert.ToString(reader["TXALUNO"]), Convert.ToString(reader["TXEMPRESA"]), Convert.ToString(reader["CORCURSO"]), Convert.ToString(reader["CORALUNO"]), Convert.ToString(reader["TXTEMA"]), Convert.ToString(reader["TXINSTRUTOR"]), Convert.ToString(reader["TXESPECIALIDADE"]), Convert.ToString(reader["CIDADECURSO"]), Convert.ToString(reader["ESTADOCURSO"]), Convert.ToString(reader["CIDADEALUNO"]), Convert.ToString(reader["ESTADOALUNO"]), Convert.ToString(reader["TXLOCAL"]), Convert.ToString(reader["TXCATEGORIA"]), Convert.ToString(reader["TXIDENTIFICADOR"]), 0));
                }
                reader.Close();
                session.Close();
        ...
        public List<Relatorios> ListarInstrutor(FormCollection collection)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    list_relat.Add(new Relatorios(8, Convert.ToString(reader["TXCURSO"]), Convert.ToString(reader["DTCURSO"]), Convert.ToString(reader["TXALUNO"]), Convert.ToString(reader["TXEMPRESA"]), Convert.ToString(reader["CORCURSO"]), Convert.ToString(reader["CORALUNO"]), Convert.ToString(reader["TXTEMA"]), Convert.ToString(reader["TXINSTRUTOR"]), Convert.ToString(reader["TXESPECIALIDADE"]), Convert.ToString(reader["CIDADECURSO"]), Convert.ToString(reader["ESTADOCURSO"]), Convert.ToString(reader["CIDADEALUNO"]), Convert.ToString(reader["ESTADOALUNO"]), Convert.ToString(reader["TXLOCAL"]), Convert.ToString(reader["TXCATEGORIA"]), Convert.ToString(reader["TXIDENTIFICADOR"]), 0));
                }
                reader.Close();
                session.Close();
